...
\begin{multicols*}{2}
    ...
    \begin{figure}[H]
        \centering
        \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1,scale=\columnwidth/10cm]
            %uncomment if require: \path (0,4782); %set diagram left start at 0, and has height of 4782
            ...
            \draw  [dash pattern={on 0.84pt off 2.51pt}]  (340,189.23) -- (28.84,188.36) ;
            ...
            \draw  [dash pattern={on 0.84pt off 2.51pt}]  (340,80.05) -- (14.72,79.18) ;
            ...
            % Text Node
            \draw (320,201.72) node [anchor=north west][inner sep=0.75pt]    {$\ x_{2}$};
            % Text Node
            ...
            % Text Node
            \draw (320,107.3) node [anchor=north west][inner sep=0.75pt]  [rotate=-89.26]  {$y_{2} -y_{1}$};
    ...
    A desigualdade triangular é a relação entre três pontos do Plano Cartesiano, onde ligados por segmentos de reta, que formam um triângulo, onde a soma de dois de lados sempre é maior que um lado, assim podemos definir uma regra geral para construção de triângulos no Plano Cartesiano
    ...
    \begin{enumerate}[(a)]
        \itemé uma parábola com concavidade para cima
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\columnwidth]{assets/rafael/img22.png}
    \end{figure}
    ...
    \begin{enumerate}[wide, labelwidth=!, labelindent=0pt]
        ...
        \item Cosseno: $\cos( \theta ) = \frac{ \mbox{Cateto Adjacente}}{\mbox{Hipotenusa}}$
