...
\begin{multicols*}{2}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{l|l|l}
        \textbf{Nome} & \textbf{Sigla} & \textbf{Equivalência} \\ \hline
        picometro quadrado    & $pm^2$             & $10^{-24}m^2$ \\ %\hline
        nanometro quadrado    & $nm^2$             & $10^{-18}m^2$ \\ %\hline
        micrometro quadrado   & $\mu m$            & $10^{-12}m^2$ \\ %\hline
        milimetro quadrado    & $mm^2$             & $10^{-6}m^2$  \\ %\hline
        centímetro quadrado   & $cm^2$             & $10^{-4}m^2$  \\ %\hline
        decímetro quadrado    & $dm^2$             & $10^{-2}m^2$  \\ %\hline
        metro quadrado        & $m^2$              & $1m^2$        \\ %\hline
        decâmetro quadrado    & $dam^2$            & \multirow{2}{*}{$100m^2$}      \\ %\hline
        are                   & $are$              &               \\ %\hline
        hêctometro quadrado   & $hm^2$             & \multirow{2}{*}{$10^4m^2$}              \\ 
        hectare               & $ha$               &               \\ %\hline
